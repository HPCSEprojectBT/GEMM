...
int main (int argc, char **argv)
{
	...
	// Define OMP # procs per rank
	if(todi){
		omp_set_num_threads(16);
		cout << "using " << 16 << " threads per task" << endl;
	}
	else{
		int nt;
		if(size > 4){
		...
		cout << "using " << nt << " threads per task" << endl;
	}
	...
	*/
	...
	// uncomment for testing center finding
	/*
	if(rank==0){
	...
	*/
	...
	// Uncomment for offset testing purposes
	/*
